# calcpy
It's some calculators and stuff in python for electronics, physic, ham radio, hifi, etc.

## Why this thing here?
Sometimes I use python as a scratch pad.

## what
```
 coni.py  -inverse conical coils inductance
